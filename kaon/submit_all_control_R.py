...
# trajs = [1090, 1130] # typeIV_b is missing these two configurations
# trajs = range(1880, 2260, 10)
# trajs = range(2190, 2230, 10)
# trajs = range(1570, 1680, 10)
# trajs = range(1680, 1710, 10)
# trajs = range(1530, 1560, 10)
# trajs = [1560]
