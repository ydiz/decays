...
void typeIV_D1a(const std::vector<int> &v, int tK, LatticeComplex &rst_Q1, LatticeComplex &rst_Q2, 
...
void typeIV_D2a(const std::vector<int> &v, int tK, LatticeComplex &rst_Q1, LatticeComplex &rst_Q2, 
                     Env &env, const std::vector<LatticePropagator> &wl, const std::vector<LatticePropagator> &ws, 
