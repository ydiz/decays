...
int main(int argc, char* argv[])
{
  ...
  for(int traj = traj_start; traj <= traj_end; traj += traj_sep) {
    ...
    vector<vector<vector<vector<Complex>>>> table4d_D1Q1 = control_R_initialize_typeV_table4d(fdims); // table4d[tK][xt][R][vt]
    vector<vector<vector<vector<Complex>>>> table4d_D1Q2 = control_R_initialize_typeV_table4d(fdims);
    vector<vector<vector<vector<Complex>>>> table4d_D2Q1 = control_R_initialize_typeV_table4d(fdims); 
    vector<vector<vector<vector<Complex>>>> table4d_D2Q2 = control_R_initialize_typeV_table4d(fdims);
    vector<vector<vector<vector<Complex>>>> table4d_sBar_d_D1 = control_R_initialize_typeV_table4d(fdims);
    vector<vector<vector<vector<Complex>>>> table4d_sBar_d_D2 = control_R_initialize_typeV_table4d(fdims);
